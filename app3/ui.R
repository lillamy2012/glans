...
shinyUI(fluidPage(
  ...
  mainPanel(
      tabsetPanel(
        ...
        tabPanel("", plotOutput("my_prot1",height="600px"),dataTableOutput("info1"),hr(),hr(),dataTableOutput("mod1"),hr(),downloadButton('downloadData1', 'Download full list'),dataTableOutput("mod2"),hr(),downloadButton('downloadData2', 'Download full list')),
